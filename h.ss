...
(define (hark stub)
  (make "src"
(sr
    (let ((gup (list "hoot" "cvt" "ref" "shew")))
      `((g++ -g -o (output "src") (input "src.ss.c.o") (input "hoot.stub.ss.c.o") (input "cvt.stub.ss.c.o") (input "hoot.impl.c.o") (input "cvt.impl.c.o")
        ...
        ,@(map gco (list "cvt.c" "GLee.c" "spew.c" "vor.c" "mem.c"))
        ...
        ,@(map gco (map (exter "stub.ss.c") gup))
        ,@(map gco (map (exter "impl.c") gup))
...
;;         (g++ -g -c -o (output "shew.impl.c.o") (input "shew.impl.c"))
        ,@(map (lambda (mod) (ss-to-c '() mod)) gup)
;;         (,compile-ss-to-c '() (input "hoot.stub.ss") (output "hoot.stub.ss.c") "hoot")
;;         (,compile-ss-to-c '() (input "cvt.stub.ss") (output "cvt.stub.ss.c") "cvt")
;;         (,compile-ss-to-c '() (input "ref.stub.ss") (output "ref.stub.ss.c") "ref")
;;         (,compile-ss-to-c '() (input "shew.stub.ss") (output "shew.stub.ss.c") "shew")
        (,gen-main src ,gup (output "src_main.c"))
