...
(define (lookup a env)
  (mtch
   ...
   ((aa value) . rest)
   (if (eq? a aa) value (lookup a rest))
...
(define (evl e env)
  (mtch
   ...
   ('App f arg)
   (evl `(Napp ,(evl f env) ,(evl arg env)) '())

   ('Napp ('$ ('Cons a b) cenv body) ('Cons aa bb))
;   (evl `(Napp ($ ,a ,cenv (Napp ($ ,b ,cenv ,body) ,bb)) ,aa) env)
   (evl `(App (/. ,a (App (/. ,b ,body) ,bb)) ,aa) cenv)

   ('Napp ('$ ('Var a) cenv body) arg)
   (evl body (cons (list a arg) cenv))

   ('Napp ('$ 'Nil cenv body) 'Nil)
   (evl body cenv)

   ('Napp ('$ ('Constant a) cenv body) ('Constant aa))
   (if (eq? a aa)
       (evl body cenv)
       'Fail)
...
(define (preprocess e)
  (mtch
   ...
   ('/. arg body)
   `(/. ,(preprocess (consify-top-layer arg)) (preprocess body))

   ('Constant a)
   e

   (a . d)
   `(Cons ,(preprocess a) ,(preprocess d))
...
;;    ('Cons a b)
;;    `(Cons ,(preprocess a) ,(preprocess b))
...
(map shew (list
;           (preprocess 'Nil)
;           (preprocess '(Cons (Constant 10) Nil))

           (preprocess '(Constant 10))
;           (preprocess '(/. (a) a))
           (preprocess '(1 2 3))
           (preprocess '(a b c))
))
...
(map shew (list
;           (evl '(/. (Cons (Var a) Nil) (Var a)) '())
;           (evl '(App (/. (Cons (Var a) Nil) (Var a)) (Constant 10)) '())
;           (evl '(Napp ($ (Cons (Var a) (Var b)) () (Var a)) (Cons (Constant 10) (Constant 20))) '())

;           (evl '(App (/. (Cons (Var a) (Var b)) (Var b)) (Cons (Constant 10) (Constant 20))) '())
;           (evl '(App (/. (Cons (Var a) (Var b)) (Var a)) (Cons (Constant 10) (Constant 20))) '())

;           (evl '(Napp ($ (Cons (Var a) (Var b)) () (Var a)) (Cons (Constant 10) (Constant 20))) '())
;           (evl '(Napp ($ (Cons (Var a) (Var b)) () (Var b)) (Cons (Constant 10) (Constant 20))) '())

;           (evl '(Napp ($ (Var a) '() (Var a)) (Constant 10)) '())

;           (evl '(Napp ($ (Constant 10) '() (Constant 20)) (Constant 10)) '())
;           (evl '(Napp ($ (Constant 20) '() (Constant 10)) (Constant 20)) '())

;           (evl '(App (/. (Cons (Var a) (Cons (Var b) Nil)) (Var a)) (Cons (Constant 10) (Cons (Constant 20) Nil))) '())
;           (evl '(App (/. (Cons (Var a) (Cons (Var b) Nil)) (Var b)) (Cons (Constant 10) (Cons (Constant 20) Nil))) '())

;           (evl '(App (/. (Cons (Var a) (Cons (Constant 20) Nil)) (Var a)) (Cons (Constant 10) (Cons (Constant 20) Nil))) '())
;           (evl '(App (/. (Cons (Constant 10) (Cons (Var b) Nil)) (Var b)) (Cons (Constant 10) (Cons (Constant 20) Nil))) '())

;           (evl '(Cons (Constant 10) (Cons (Constant 20) Nil)) '())
;           (evl '(Cons (Constant 10) Nil) '())

;;            (evl '(Var a) '((a (Constant 10)) (b (Constant 20))))
;;            (evl '(Var b) '((a (Constant 10)) (b (Constant 20))))
;;            (lookup 'a '((a (Constant 10)) (b (Constant 20))))
;;            (lookup 'b '((a (Constant 10)) (b (Constant 20))))

;;            (evl '(/. (a) a) '())
;;            (evl '(App (/. (a) a) (Constant 10)) '())
;;           (evl '(Napp ($ (Cons a Nil) () a) (Cons (Constant 10) Nil)) '())
))
