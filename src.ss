(foreign "hoot" ("hoot.c" "GLee.c") "" "-framework GLUT -framework OpenGL -framework CoreFoundation")
(foreign "cvt" ("cvt.c") "" "-framework GLUT -framework OpenGL -framework CoreFoundation")
